"""
cogs/hunt.py — Vibe creature hunt system.

Commands:
  /hunt          (slash)    noxie hunt     (prefix)
  /inventory     (slash)    noxie inventory (prefix)
  /vibe          (slash)    noxie vibe      (prefix)

CV2 containers defined here:
  build_hunt_container      — hunt result card
  build_inventory_container — paged collection list
  build_creature_container  — single creature detail card
"""
...
class HuntCog(commands.Cog, name="Hunt"):
    ...
    async def inventory_slash(
        ...
        comps, files = build_inventory_container(
